...
# # [!!] moved to env_utils
# def _make_env_fn(
#     config: Config, dataset = None, rank: int = 0
# ):
...
class VectorEnv:
    ...
    # [!!] Ignore parameter types since we're not using habitat core
    ...
    # [!!] Ignore habitat parameter typing
    def __init__(
        self,
        make_env_fn,
        env_fn_args=None,
        ...
        try:
            ...
            while command != CLOSE_COMMAND:
                if command == STEP_COMMAND:
                    ...
                    # [!!] Just a single step method for our THOR envs
